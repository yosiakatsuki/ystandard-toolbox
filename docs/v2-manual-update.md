...
本文案は、単なる操作マニュアルではなく機能紹介も兼ねた構成にする。
ページ上部には、短くてもよいのでマーケター視点で「この機能の一押しポイント」を入れる。
その後に、機能の使い方・設定項目・注意点を説明する。
...
- 作成資料
  - `docs/v2-manual/ystdtb-heading.md`
  - `docs/v2-manual/ystdtb-heading-migration-v1.md`
- v2 での主な変更点
