...
- [ ] yStandard テーマ以外での警告文の調整
- [ ] Toolbox 機能ページで yStandard 連携機能だとわかりやすく表示
- [ ] yStandard テーマ以外では Toolbox 機能ページから設定ページへのリンクを非表示にする
- [ ] 非yStandardで使える機能の精査と有効化
  - フォント設定（`class-font.php`）: 非yStandardでも使えるようにする
