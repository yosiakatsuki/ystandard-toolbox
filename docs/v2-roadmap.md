...
- [x] プラグイン設定画面の全項目 — 詳細は [v2-settings-testing.md](v2-settings-testing.md)
	- [x] サイトデザイン拡張
	- [x] 見出しデザイン（レスポンシブ構造統一後の再確認）
	- [x] フォント
	- [x] カスタム CSS
	- [x] コード追加
	- [x] 投稿詳細ページ拡張（CTA 等）
	- [x] ブロックパターン設定
- [x] yStandard 連携機能の動作確認（フォント / アイコンフォント / 見出しデザイン / SEO 連携 等）
- [x] ブロック拡張（Block Hook 含む）

- [x] ウィジェット編集画面でエラーが出ているので対処
```
...
- [x] 共通機能の動作確認（ブロック / 設定画面 / メタボックス）
- [x] yStandard 専用機能が非表示になっていること
- [x] クラシックテーマで有効な機能（フォント設定・アイコンフォント等）の動作確認

#### 3.3.2 ハイブリッドテーマ

- [x] 共通機能の動作確認
- [x] yStandard 専用機能が非表示になっていること
- [x] ハイブリッドテーマで有効な機能の動作確認

#### 3.3.3 ブロックテーマ

- [x] 共通機能の動作確認
- [x] yStandard 専用機能が非表示になっていること
- [x] フォント設定が非表示になっていること（ブロックテーマは theme.json 管轄）
- [x] アイコンフォント等、ブロックテーマでも有効な機能の動作確認

## フェーズ4: リリースノートの更新

- [ ] README のバージョンアップ情報（Changelog）に v2 の変更内容を反映
- [ ] 主な変更点・破壊的変更・移行時の注意点を整理して記載

## フェーズ5: マニュアル更新

- [ ] マニュアルの更新

## フェーズ6: 共通ルール策定（リリース後でも可）
