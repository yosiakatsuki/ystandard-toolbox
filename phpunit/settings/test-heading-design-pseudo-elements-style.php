	...
	function test_parse_styles_pseudo_elements_color() {
		...
		$expected = [
			'desktop' => [
				...
				'--ystdtb-custom-heading-after-bg-color-rgba' => 'rgba(255,255,255,var(--ystdtb-custom-heading-after-bg-color-rgba-opacity,1))',
			],
		];
	...
	function test_parse_styles_pseudo_elements_base() {
		...
		$expected = [
			'desktop' => [
				...
				'--ystdtb-custom-heading-before-bg-color-rgba' => 'rgba(255,255,255,var(--ystdtb-custom-heading-before-bg-color-rgba-opacity,1))',
				'margin-top'                                   => '10px',
				'margin-bottom'                                => '20px',
			],
			'tablet'  => [
