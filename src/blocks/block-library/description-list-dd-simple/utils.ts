 ...
 * Block Dependencies.
 */
import type { DdSimpleBlockAttributes } from './types';

export function getDdSimpleBlockClasses( attributes: DdSimpleBlockAttributes ) {
	const {
		textSize,
		customTextSize,
		responsiveTextSize,
	...
	return classnames( 'ystdtb-dd-simple', {
...
export function getDdSimpleBlockStyles( attributes: DdSimpleBlockAttributes ) {
	const {
		margin,
		responsiveMargin,
		padding,
