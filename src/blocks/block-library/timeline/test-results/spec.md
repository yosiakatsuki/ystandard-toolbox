...
- 本仕様の fixture 数は 37 件（label-type 3 / label-icon 2 / label-text 2 / label-size 2 / label-radius 2 / label-bold 2 / label-font 2 / label-color 2 / label-bg 2 / label-border 2 / label-border-color 2 / contents-margin 2 / border-size 2 / border-color 2 / margin-top 2 / child 3 / combo 5）
